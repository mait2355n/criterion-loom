...
> Criterion Loom has a public v0.1 snapshot with the required repository
> components in place. It is now being improved for audit performance,
> coverage, and agent-side revision-loop use.

This replaces the weaker framing that it is only an unfinished sketch, but it
must not become an overclaim that Criterion Loom is a finished requirements
...
documentation, and public positioning notes.
...
The public v0.1 stance is only valid while these repository facts remain true:
...
- Public wording keeps the local-fixture, heuristic-check, and
  human-final-decision limits visible.
...
Use this short Japanese wording for README summaries and repository-facing
material:
...
- Public v0.1 means "repository snapshot with required components in place", not "finished requirements engineering product".
...
- `README.md`
  ...
  - Say public v0.1 has the required repository components in place.
...
- `README.ja.md`
  ...
  - Keep the heuristic-check, local-fixture, and human-final-decision boundaries.
...
### P1: Update Public Positioning Documents

Update Japanese outward-facing material to use the new completion stance:

- `docs/ja/public-positioning-note.md`
  - Present Criterion Loom as a public v0.1 snapshot with the required repository components in place.
