...
- Add public repository health files: `CODE_OF_CONDUCT.md`, `SUPPORT.md`, and Dependabot configuration.
- Add public-readiness documentation for the GitHub presentation shape.
- Clarify README quickstart and first-reader navigation before the deeper CLI reference.
...
- Add a GitHub Actions CI template for Python 3.11 and 3.13 compile, unit tests, fixture evaluation, and `doctor`.
