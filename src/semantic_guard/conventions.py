...
from semantic_guard.expression_precision import expression_precision_findings
from semantic_guard.models import AuditResult, Finding
from semantic_guard.resources import resource_path
from semantic_guard.text_matching import has_any as _has_any
...
def audit_conventions(
    ...
    *,
    ...
    expression_findings, expression_details = expression_precision_findings(
        combined,
        catalog,
        rule_severity=lambda rule: _rule_severity(rule, strict=strict, catalog=catalog),
    )
